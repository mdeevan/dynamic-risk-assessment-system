...
class Score_Model():
    ...
    def make_predictions(self) -> str:
        ...
        input_file = utilities.get_filename(p_filename=self.ingested_file_name,
                                            p_parent_folder=self.parent_folder,
        ...
        try:
            ...
            logging.error(f"%s: scoring: error making prediction %s", func_name, err)
            raise
